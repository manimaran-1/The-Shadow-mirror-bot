...
class GoogleDriveHelper:
    ...
    def __upload_empty_file(self, path, file_name, mime_type, parent_id=None):
        ...
        file_metadata = {
            'name': file_name,
            'description': '𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐔𝐬𝐢𝐧𝐠 𝐌𝐨𝐯𝐢𝐞𝐬𝐄𝐦𝐩𝐢𝐫𝐞 𝐁𝐨𝐭',
            'mimeType': mime_type,
        }
    ...
    def upload(self, file_name: str):
        ...
        LOGGER.info("𝐔𝐩𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐅𝐢𝐥𝐞: " + file_path)
        ...
        if os.path.isfile(file_path):
            try:
                ...
                if link is None:
                    raise Exception('')
                LOGGER.info("𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐓𝐨 𝐆-𝐃𝐫𝐢𝐯𝐞: " + file_path)
            ...
            try:
                ...
                if result is None:
                    raise Exception('𝐔𝐩𝐥𝐨𝐚𝐝 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐦𝐚𝐧𝐮𝐚𝐥𝐥𝐲 𝐜𝐚𝐧𝐜𝐞𝐥𝐥𝐞𝐝!')
                link = f"https://drive.google.com/folderview?id={dir_id}"
                if self.is_cancelled:
                    LOGGER.info("𝐃𝐞𝐥𝐞𝐭𝐢𝐧𝐠 𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐃𝐚𝐝𝐚 𝐅𝐫𝐨𝐦 𝐃𝐫𝐢𝐯𝐞...")
                    msg = self.deletefile(link)
                    LOGGER.info(f"{msg}")
                    return
                LOGGER.info("𝐔𝐩𝐥𝐨𝐚𝐝𝐞𝐝 𝐓𝐨 𝐆-𝐃𝐫𝐢𝐯𝐞: " + file_name)
            except Exception as e:
                if isinstance(e, RetryError):
                    LOGGER.info(f"Total Attempts: {e.last_attempt.attempt_number}")
                    err = e.last_attempt.exception()
    ...
    def clone(self, link):
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if self.is_cancelled:
                    LOGGER.info("𝐃𝐞𝐥𝐞𝐭𝐢𝐧𝐠 𝐜𝐥𝐨𝐧𝐞𝐝 𝐝𝐚𝐭𝐚 𝐟𝐫𝐨𝐦 𝐃𝐫𝐢𝐯𝐞...")
                    msg = self.deletefile(durl)
                    LOGGER.info(f"{msg}")
                    return "𝐘𝐨𝐮𝐫 𝐜𝐥𝐨𝐧𝐞 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐬𝐭𝐨𝐩𝐩𝐞𝐝 𝐚𝐧𝐝 𝐜𝐥𝐢𝐧𝐞𝐝 𝐝𝐚𝐭𝐚 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐝𝐞𝐥𝐞𝐭𝐞𝐝!", "𝐂𝐚𝐧𝐜𝐞𝐥𝐥𝐞𝐝"
                msg += f'𝐅𝐢𝐥𝐞𝐧𝐚𝐦𝐞: <code>{meta.get("name")}</code>\n<b>𝐒𝐢𝐳𝐞: </b><code>{get_readable_file_size(self.transferred_size)}</code>'
                msg += '\n𝐓𝐲𝐩𝐞: <code>Folder</code>'
                msg += f'\n𝐒𝐮𝐛𝐅𝐨𝐥𝐝𝐞𝐫𝐬: <code>{self.total_folders}</code>'
                msg += f'\n𝐅𝐢𝐥𝐞𝐬: <code>{self.total_files}</code>'
                buttons = button_build.ButtonMaker()
                if SHORTENER is not None and SHORTENER_API is not None:
                    surl = short_url(durl)
                    buttons.buildbutton("☁️ 𝐃𝐫𝐢𝐯𝐞 𝐋𝐢𝐧𝐤", surl)
                else:
                    buttons.buildbutton("☁️ 𝐃𝐫𝐢𝐯𝐞 𝐋𝐢𝐧𝐤", durl)
                ...
                msg += f'𝐅𝐢𝐥𝐞𝐍𝐚𝐦𝐞: <code>{file.get("name")}</code>'
                ...
                try:
                    ...
                    typ = 'File'
                try:
                    msg += f'\n𝐒𝐢𝐳𝐞: <code>{get_readable_file_size(int(meta.get("size")))}</code>'
                    msg += f'\n𝐓𝐲𝐩𝐞: <code>{typ}</code>'
                except TypeError:
                    pass
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        if VIEW_LINK:
                            ...
                            buttons.buildbutton("🌐 𝐕𝐢𝐞𝐰 𝐥𝐢𝐧𝐤", siurls)
                    else:
                        buttons.buildbutton("⚡  𝐈𝐧𝐝𝐞𝐱 𝐋𝐢𝐧𝐤", url)
                        if VIEW_LINK:
    ...
    def edit_telegraph(self):
        ...
        for content in self.telegraph_content :
            if nxt_page == 1 :
                content += f'<b><a href="https://telegra.ph/{self.path[nxt_page]}">𝐍𝐞𝐱𝐭</a></b>'
                nxt_page += 1
            else :
                if prev_page <= self.num_of_path:
                    content += f'<b><a href="https://telegra.ph/{self.path[prev_page]}">𝐏𝐫𝐞𝐯</a></b>'
                    prev_page += 1
                if nxt_page < self.num_of_path:
                    content += f'<b> | <a href="https://telegra.ph/{self.path[nxt_page]}">𝐍𝐞𝐱𝐭</a></b>'
                    nxt_page += 1
            Telegraph(access_token=telegraph_token).edit_page(path = self.path[prev_page],
                                 title = '𝐌𝐨𝐯𝐢𝐞𝐬𝐄𝐧𝐩𝐢𝐫𝐞 𝐒𝐞𝐚𝐫𝐜𝐡',
                                 author_name='𝐌𝐨𝐯𝐢𝐞𝐬𝐄𝐦𝐩𝐢𝐫𝐞 𝐁𝐨𝐭',
                                 author_url='https://t.me/TheEmpireGroup/4',
    ...
    def drive_list(self, fileName, stopDup=False, noMulti=False):
        ...
        for index, parent_id in enumerate(DRIVES_IDS):
            ...
            if not response["files"] and noMulti:
                ...
                continue
            if not Title:
                msg += f'<h4>𝐒𝐞𝐚𝐫𝐜𝐡 𝐑𝐞𝐬𝐮𝐥𝐭 𝐅𝐨𝐫: {fileName}</h4><br><br>'
                Title = True
                ...
                if file.get('mimeType') == "application/vnd.google-apps.folder":
                    ...
                    if INDEX_URLS[index] is not None:
                        ...
                        if SHORTENER is not None and SHORTENER_API is not None:
                            ...
                            if VIEW_LINK:
                                siurls = short_url(urls)
                                msg += f' <b>| <a href="{siurls}">𝐕𝐢𝐞𝐰 𝐋𝐢𝐧𝐤</a></b>'
                        else:
                            msg += f' <b>| <a href="{url}">𝐈𝐧𝐝𝐞𝐱 𝐋𝐢𝐧𝐤</a></b>'
                            if VIEW_LINK:
                                msg += f' <b>| <a href="{urls}">𝐕𝐢𝐞𝐰 𝐋𝐢𝐧𝐤</a></b>'
                msg += '<br><br>'
                content_count += 1
        ...
        buttons = button_build.ButtonMaker()
        buttons.buildbutton("🔎 𝐕𝐈𝐄𝐖", f"https://telegra.ph/{self.path[0]}")
    ...
    def count(self, link):
        ...
        try:
            ...
            if drive_file['mimeType'] == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'𝐅𝐢𝐥𝐞𝐧𝐚𝐦𝐞: <code>{name}</code>'
                msg += f'\n𝐒𝐢𝐳𝐞: <code>{get_readable_file_size(self.total_bytes)}</code>'
                msg += '\n𝐓𝐲𝐩𝐞: <code>Folder</code>'
                msg += f'\n𝐒𝐮𝐛𝐅𝐨𝐥𝐝𝐞𝐫𝐬: <code>{self.total_folders}</code>'
                msg += f'\n𝐅𝐢𝐥𝐞𝐬: <code>{self.total_files}</code>'
            else:
            ...
            err = str(err).replace('>', '').replace('<', '')
            LOGGER.error(err)
            msg = "𝐅𝐢𝐥𝐞𝐧 𝐧𝐨𝐭 𝐟𝐨𝐮𝐧𝐝." if "File not found" in str(err) else f"Error.\n{err}"
            return msg
        return msg
    ...
    def clonehelper(self, link):
        ...
        try:
            ...
            err = str(err).replace('>', '').replace('<', '')
            LOGGER.error(err)
            msg = "𝐅𝐢𝐥𝐞 𝐧𝐨𝐭 𝐟𝐨𝐮𝐧𝐝." if "File not found" in str(err) else f"Error.\n{err}"
            return msg, "", "", ""
    ...
    def cancel_download(self):
        ...
        if self.is_downloading:
            ...
            self.__listener.onDownloadError('𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐬𝐭𝐨𝐩𝐩𝐞𝐝 𝐛𝐲 𝐮𝐬𝐞𝐫!')
        elif self.is_cloning:
            LOGGER.info(f"Cancelling Clone: {self.name}")
        elif self.is_uploading:
            LOGGER.info(f"Cancelling Upload: {self.name}")
            self.__listener.onUploadError('𝐘𝐨𝐮𝐫 𝐮𝐩𝐥𝐨𝐚𝐝 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐬𝐭𝐨𝐩𝐩𝐞𝐝 𝐚𝐧𝐝 𝐮𝐩𝐥𝐨𝐚𝐝 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐝𝐞𝐥𝐞𝐭𝐞𝐝!')
